...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.nexosprueba.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.nexosprueba.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.nexosprueba.app.domain.User.class.getName());
